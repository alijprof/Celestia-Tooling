...
read selectnetwork
echo
if test "$selectnetwork" == "1"; then
    NETWORK="mocha"
    echo "export NETWORK=$NETWORK" >> $HOME/.bash_profile
    source $HOME/.bash_profile
elif test "$selectnetwork" == "2"; then
    NETWORK="blockspacerace"
    echo "export NETWORK=$NETWORK" >> $HOME/.bash_profile
    source $HOME/.bash_profile
elif test "$selectnetwork" == "3"; then
    NETWORK="arabica"
    echo "export NETWORK=$NETWORK" >> $HOME/.bash_profile
    source $HOME/.bash_profile
fi
